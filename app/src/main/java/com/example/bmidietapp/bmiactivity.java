...
public class bmiactivity extends AppCompatActivity {
    ...
    TextView mbmidisplay,imagedisplay,mweightdisplay,mheightdisplay,mbmicategory,mgender,username;
    Button mgotomain;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mchoosediet=findViewById(R.id.choosediet);
        ...
        else if(intbmi<16.9 && intbmi>16)
        {
            ...
            mbackground.setBackgroundColor(R.drawable.ok);
        ...
        mchoosediet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(bmiactivity.this,choosediet.class);
                startActivity(intent);
                finish();
